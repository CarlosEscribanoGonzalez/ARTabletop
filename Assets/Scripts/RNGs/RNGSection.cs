...
public class RNGSection : MonoBehaviour
{
    ...
    [SerializeField] private bool gameHasCoin = true; //Indica si las monedas están configuradas para el juego
    ...
    private void Start()
    {
        ...
        if (!gameHasCoin) Destroy(coinButton.gameObject); //Si no hay ruleta el botón se destruye
